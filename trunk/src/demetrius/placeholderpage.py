...
"""A placeholder page that tells the user 
that the feature on this page is not yet implemented.
"""
...
class PlaceholderPage(pageclasses.DemetriusPage):
    
    _PAGE_TEMPLATE = 'demetrius/feature_not_implemented.ezt'
